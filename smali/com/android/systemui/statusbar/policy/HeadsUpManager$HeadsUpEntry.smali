...
.method public removeAsSoonAsPossible()V
    ...
    invoke-static {v0}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get4(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)Landroid/os/Handler;
    ...
    invoke-static {v4}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get1(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)Lcom/android/systemui/statusbar/policy/HeadsUpManager$Clock;
...
.method public setEntry(Lcom/android/systemui/statusbar/NotificationData$Entry;)V
    ...
    invoke-static {v0}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get1(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)Lcom/android/systemui/statusbar/policy/HeadsUpManager$Clock;
    ...
    invoke-static {v2}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get10(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)I
...
.method public updateEntry(Z)V
    ...
    invoke-static {v5}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get1(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)Lcom/android/systemui/statusbar/policy/HeadsUpManager$Clock;

    move-result-object v5

    invoke-virtual {v5}, Lcom/android/systemui/statusbar/policy/HeadsUpManager$Clock;->currentTimeMillis()J
    ...
    invoke-static {v5}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get6(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)I
    ...
    iput-wide v8, p0, Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;->earliestRemovaltime:J

    .line 717
    if-eqz p1, :cond_0

    .line 718
    iget-wide v8, p0, Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;->postTime:J

    invoke-static {v8, v9, v0, v1}, Ljava/lang/Math;->max(JJ)J

    move-result-wide v8

    iput-wide v8, p0, Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;->postTime:J
    ...
    invoke-static {v5}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get2(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)Ljava/util/HashSet;

    move-result-object v5

    iget-object v8, p0, Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;->entry:Lcom/android/systemui/statusbar/NotificationData$Entry;
    ...
    invoke-static {v5}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get3(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)Landroid/util/ArraySet;
    ...
    invoke-virtual {v5}, Landroid/app/MiuiNotification;->getFloatTime()I

    move-result v4

    .line 729
    .local v4, "floatTime":I
    iget-wide v8, p0, Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;->postTime:J

    if-lez v4, :cond_4

    .end local v4    # "floatTime":I
    :goto_0
    int-to-long v10, v4
    ...
    .line 731
    .local v6, "removeDelay":J
    iget-object v5, p0, Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;->this$0:Lcom/android/systemui/statusbar/policy/HeadsUpManager;

    invoke-static {v5}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get4(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)Landroid/os/Handler;

    move-result-object v5

    iget-object v8, p0, Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;->mRemoveHeadsUpRunnable:Ljava/lang/Runnable;

    invoke-virtual {v5, v8, v6, v7}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z

    .line 714
    .end local v2    # "finishTime":J
    .end local v6    # "removeDelay":J
    :cond_3
    return-void

    .line 729
    .restart local v4    # "floatTime":I
    :cond_4
    iget-object v5, p0, Lcom/android/systemui/statusbar/policy/HeadsUpManager$HeadsUpEntry;->this$0:Lcom/android/systemui/statusbar/policy/HeadsUpManager;

    invoke-static {v5}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get5(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)I
...
.method public wasShownLongEnough()Z
    ...
    invoke-static {v2}, Lcom/android/systemui/statusbar/policy/HeadsUpManager;->-get1(Lcom/android/systemui/statusbar/policy/HeadsUpManager;)Lcom/android/systemui/statusbar/policy/HeadsUpManager$Clock;
