...
.method private createOption(II)Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;
    ...
    invoke-direct {v4, v6, p2, v5, v3}, Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;-><init>(Landroid/service/notification/SnoozeCriterionCompat;ILjava/lang/CharSequence;Ljava/lang/CharSequence;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 197
    iget-object v10, p0, Lcom/android/systemui/statusbar/NotificationSnooze;->mGutsContainer:Lcom/android/systemui/statusbar/NotificationGuts;
    ...
    invoke-virtual {v10}, Lcom/android/systemui/statusbar/NotificationGuts;->resetFalsingCheck()V
    ...
    .line 206
    iget-boolean v10, p0, Lcom/android/systemui/statusbar/NotificationSnooze;->mExpanded:Z
    ...
    .line 209
    :cond_3
    iput-object v11, p0, Lcom/android/systemui/statusbar/NotificationSnooze;->mSelectedOption:Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;
    ...
    invoke-virtual {v10, v3}, Lcom/android/systemui/statusbar/NotificationGuts;->getLocationOnScreen([I)V
    ...
    .line 219
    iget-object v9, p0, Lcom/android/systemui/statusbar/NotificationSnooze;->mGutsContainer:Lcom/android/systemui/statusbar/NotificationGuts;

    invoke-virtual {v9, v6, v7, v8, v8}, Lcom/android/systemui/statusbar/NotificationGuts;->closeControls(IIZZ)V
...
.method public setSnoozeOptions(Ljava/util/List;)V
    ...
    .prologue
    .line 93
    .local p1, "snoozeList":Ljava/util/List;, "Ljava/util/List<Landroid/service/notification/SnoozeCriterionCompat;>;"
    if-nez p1, :cond_0
    ...
    check-cast v2, Landroid/service/notification/SnoozeCriterionCompat;

    .line 101
    .local v2, "sc":Landroid/service/notification/SnoozeCriterionCompat;
    iget-object v3, p0, Lcom/android/systemui/statusbar/NotificationSnooze;->mSnoozeOptions:Ljava/util/List;

    new-instance v4, Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;

    invoke-virtual {v2}, Landroid/service/notification/SnoozeCriterionCompat;->getExplanation()Ljava/lang/CharSequence;

    move-result-object v5

    invoke-virtual {v2}, Landroid/service/notification/SnoozeCriterionCompat;->getConfirmation()Ljava/lang/CharSequence;

    move-result-object v6

    const/4 v7, 0x0

    invoke-direct {v4, v2, v7, v5, v6}, Lcom/android/systemui/plugins/statusbar/NotificationSwipeActionHelper$SnoozeOption;-><init>(Landroid/service/notification/SnoozeCriterionCompat;ILjava/lang/CharSequence;Ljava/lang/CharSequence;)V
    ...
    .line 103
    .end local v2    # "sc":Landroid/service/notification/SnoozeCriterionCompat;
    :cond_1
    invoke-direct {p0}, Lcom/android/systemui/statusbar/NotificationSnooze;->createOptionViews()V
