...
.method private handleDockKey(J)V
    ...
    invoke-virtual {v2}, Lcom/android/systemui/stackdivider/DividerView;->getSnapAlgorithm()Lcom/android/systemui/stackdivider/DividerSnapAlgorithm;

    move-result-object v7

    .line 125
    .local v7, "snapAlgorithm":Lcom/android/systemui/stackdivider/DividerSnapAlgorithm;
    ...
    invoke-virtual {v7, v1}, Lcom/android/systemui/stackdivider/DividerSnapAlgorithm;->calculateNonDismissingSnapTarget(I)Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;

    move-result-object v0

    .line 128
    .local v0, "currentTarget":Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;
    const-wide v10, 0x1000000000047L
    ...
    .line 129
    invoke-virtual {v7, v0}, Lcom/android/systemui/stackdivider/DividerSnapAlgorithm;->getPreviousTarget(Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;)Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;

    move-result-object v8

    .line 131
    .local v8, "target":Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;
    :goto_2
    const/4 v10, 0x1
    ...
    .line 132
    iget v10, v8, Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;->position:I
    ...
    .line 135
    .end local v0    # "currentTarget":Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;
    .end local v1    # "dividerPosition":I
    .end local v2    # "dividerView":Lcom/android/systemui/stackdivider/DividerView;
    .end local v4    # "dockSide":I
    .end local v7    # "snapAlgorithm":Lcom/android/systemui/stackdivider/DividerSnapAlgorithm;
    .end local v8    # "target":Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;
    :catch_0
    move-exception v5
    ...
    .restart local v0    # "currentTarget":Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;
    .restart local v1    # "dividerPosition":I
    .restart local v2    # "dividerView":Lcom/android/systemui/stackdivider/DividerView;
    .restart local v4    # "dockSide":I
    .restart local v7    # "snapAlgorithm":Lcom/android/systemui/stackdivider/DividerSnapAlgorithm;
    :cond_3
    :try_start_1
    invoke-virtual {v7, v0}, Lcom/android/systemui/stackdivider/DividerSnapAlgorithm;->getNextTarget(Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;)Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0

    move-result-object v8

    .restart local v8    # "target":Lcom/android/systemui/stackdivider/DividerSnapAlgorithm$SnapTarget;
    goto :goto_2
.end method
