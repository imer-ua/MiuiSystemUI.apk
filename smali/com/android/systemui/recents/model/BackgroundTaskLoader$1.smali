...
.method constructor <init>(Lcom/android/systemui/recents/model/BackgroundTaskLoader;Lcom/android/systemui/recents/model/Task;Lcom/android/systemui/recents/model/ThumbnailData;Landroid/graphics/drawable/Drawable;)V
    .locals 0
    .param p1, "this$0"    # Lcom/android/systemui/recents/model/BackgroundTaskLoader;
    .param p2, "val$t"    # Lcom/android/systemui/recents/model/Task;
    .param p3, "val$newThumbnailData"    # Lcom/android/systemui/recents/model/ThumbnailData;
    .param p4, "val$newIcon"    # Landroid/graphics/drawable/Drawable;
...
.method public run()V
    ...
    iget-object v3, v3, Lcom/android/systemui/recents/model/ThumbnailData;->thumbnailInfo:Lcom/android/systemui/proxy/ActivityManager$TaskThumbnailInfo;

    .line 221
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/systemui/recents/model/Task;->notifyTaskDataLoaded(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Lcom/android/systemui/proxy/ActivityManager$TaskThumbnailInfo;)V
